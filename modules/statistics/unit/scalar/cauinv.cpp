...
//   NT2_TEST_ULP_EQUAL(cauinv(nt2::Quarter<T>()), nt2::Mone<T>(), 0);
//   NT2_TEST_ULP_EQUAL(cauinv(nt2::Quarter<T>()*3), nt2::0ne<T>(), 0);
...
NT2_TEST_CASE_TPL ( cauinv_2,  NT2_REAL_TYPES)
{
  ...
  nt2::table<T> a = nt2::reshape(nt2::linspace(T(0), T(1), 16), 4, 4);
  NT2_DISPLAY(a); 
