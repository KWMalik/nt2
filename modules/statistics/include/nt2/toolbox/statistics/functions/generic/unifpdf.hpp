...
namespace nt2 { namespace ext
{
  namespace details
  {
    template < class A0, class A1, class A2 > struct unifpdf_1 // at least 2 ast 
    {
      ...
      {
        T z = nt2::bsxfun(nt2::functor<tag::minus_>(),a2,a1); //this must be scheduled
        return nt2::bsxfun(nt2::functor<tag::if_allbits_else_>(),
                           nt2::bsxfun(nt2::functor<tag::logical_or_>(), is_lez(z), is_nan(a0)),
                           nt2::bsxfun(nt2::functor<tag::if_zero_else_>(),
                                       nt2::bsxfun(nt2::functor<tag::logical_or_>(), lt(a0,a1),gt(a0,a2)),
                                       nt2::rec(z)
                                       )
                           ); 
